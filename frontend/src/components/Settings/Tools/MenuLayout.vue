...
export default {
  data() {
    return {
      ...
      layout: themeSettingsStore.menuLayout,
      menucollaspse: themeSettingsStore.sidebarCollasp,
      menuHideen: themeSettingsStore.sidebarHidden,
      layouts: [
        {
          value: "vertical",
          label: "Vertical",
  ...
  watch: {
    layout: {
      handler() {
        switch (this.layout) {
          case "vertical":
            themeSettingsStore.menuLayout = this.layout;
    ...
    menuHideen: {
      handler() {
        themeSettingsStore.sidebarHidden = this.menuHideen;
      },
      immediate: true,
    },
    menucollaspse: {
      handler() {
        themeSettingsStore.sidebarCollasp = this.menucollaspse;
      },
      immediate: true,
    },
  },
