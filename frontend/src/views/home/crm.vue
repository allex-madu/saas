          ...
          <Card>
            ...
            <div class="legend-ring">
              <apexchart
                type="bar"
                height="410"
                :options="isDark ? stackedDark.chartOptions : stacked.chartOptions"
          ...
          <Card title="trends calculation">
            ...
            <div class="legend-ring3">
              <apexchart
                type="pie"
                height="335"
                :options="isDark ? pieChartDark.chartOptions : pieChart.chartOptions"
